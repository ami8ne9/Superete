    ...
    public class InvoiceRepository
    {
        ...
        private Invoice MapInvoiceFromReader(SqlDataReader reader)
        {
            return new Invoice
            {
                ...
                InvoiceIndex = reader.IsDBNull(reader.GetOrdinal("InvoiceIndex")) ? null : reader.GetString(reader.GetOrdinal("InvoiceIndex")),
                CreditClientName = reader.IsDBNull(reader.GetOrdinal("CreditClientName")) ? null : reader.GetString(reader.GetOrdinal("CreditClientName")),
                CreditMontant = reader.IsDBNull(reader.GetOrdinal("CreditMontant")) ? 0 : reader.GetDecimal(reader.GetOrdinal("CreditMontant")),
                Objet = reader.IsDBNull(reader.GetOrdinal("Objet")) ? null : reader.GetString(reader.GetOrdinal("Objet")),
                NumberLetters = reader.IsDBNull(reader.GetOrdinal("NumberLetters")) ? null : reader.GetString(reader.GetOrdinal("NumberLetters")),
                NameFactureGiven = reader.IsDBNull(reader.GetOrdinal("NameFactureGiven")) ? null : reader.GetString(reader.GetOrdinal("NameFactureGiven")),
                NameFactureReceiver = reader.IsDBNull(reader.GetOrdinal("NameFactureReceiver")) ? null : reader.GetString(reader.GetOrdinal("NameFactureReceiver")),
                ReferenceClient = reader.IsDBNull(reader.GetOrdinal("ReferenceClient")) ? null : reader.GetString(reader.GetOrdinal("ReferenceClient")),
                UserName = reader.IsDBNull(reader.GetOrdinal("UserName")) ? null : reader.GetString(reader.GetOrdinal("UserName")),
                UserICE = reader.IsDBNull(reader.GetOrdinal("UserICE")) ? null : reader.GetString(reader.GetOrdinal("UserICE")),
                UserVAT = reader.IsDBNull(reader.GetOrdinal("UserVAT")) ? null : reader.GetString(reader.GetOrdinal("UserVAT")),
                UserPhone = reader.IsDBNull(reader.GetOrdinal("UserPhone")) ? null : reader.GetString(reader.GetOrdinal("UserPhone")),
                UserAddress = reader.IsDBNull(reader.GetOrdinal("UserAddress")) ? null : reader.GetString(reader.GetOrdinal("UserAddress")),
                UserEtatJuridique = reader.IsDBNull(reader.GetOrdinal("UserEtatJuridique")) ? null : reader.GetString(reader.GetOrdinal("UserEtatJuridique")),
                UserIdSociete = reader.IsDBNull(reader.GetOrdinal("UserIdSociete")) ? null : reader.GetString(reader.GetOrdinal("UserIdSociete")),
                UserSiegeEntreprise = reader.IsDBNull(reader.GetOrdinal("UserSiegeEntreprise")) ? null : reader.GetString(reader.GetOrdinal("UserSiegeEntreprise")),
                ClientName = reader.IsDBNull(reader.GetOrdinal("ClientName")) ? null : reader.GetString(reader.GetOrdinal("ClientName")),
                ClientICE = reader.IsDBNull(reader.GetOrdinal("ClientICE")) ? null : reader.GetString(reader.GetOrdinal("ClientICE")),
                ClientVAT = reader.IsDBNull(reader.GetOrdinal("ClientVAT")) ? null : reader.GetString(reader.GetOrdinal("ClientVAT")),
                ClientPhone = reader.IsDBNull(reader.GetOrdinal("ClientPhone")) ? null : reader.GetString(reader.GetOrdinal("ClientPhone")),
                ClientAddress = reader.IsDBNull(reader.GetOrdinal("ClientAddress")) ? null : reader.GetString(reader.GetOrdinal("ClientAddress")),
                ClientEtatJuridique = reader.IsDBNull(reader.GetOrdinal("ClientEtatJuridique")) ? null : reader.GetString(reader.GetOrdinal("ClientEtatJuridique")),
                ClientIdSociete = reader.IsDBNull(reader.GetOrdinal("ClientIdSociete")) ? null : reader.GetString(reader.GetOrdinal("ClientIdSociete")),
                ClientSiegeEntreprise = reader.IsDBNull(reader.GetOrdinal("ClientSiegeEntreprise")) ? null : reader.GetString(reader.GetOrdinal("ClientSiegeEntreprise")),
                Currency = reader.IsDBNull(reader.GetOrdinal("Currency")) ? "DH" : reader.GetString(reader.GetOrdinal("Currency")),
                TVARate = reader.GetDecimal(reader.GetOrdinal("TVARate")),
                TotalHT = reader.GetDecimal(reader.GetOrdinal("TotalHT")),
                TotalTVA = reader.GetDecimal(reader.GetOrdinal("TotalTVA")),
                TotalTTC = reader.GetDecimal(reader.GetOrdinal("TotalTTC")),
                Remise = reader.GetDecimal(reader.GetOrdinal("Remise")),
                TotalAfterRemise = reader.GetDecimal(reader.GetOrdinal("TotalAfterRemise")),
                EtatFacture = reader.GetInt32(reader.GetOrdinal("EtatFacture")),
                IsReversed = reader.GetBoolean(reader.GetOrdinal("IsReversed")),
